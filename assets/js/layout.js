/* الهيدر والتذييل المشتركان لكل صفحات موقع طيّبات للأغذية.
...
(function () {
  ...
  var T = {
    ...
    fBlurb:    { ar: "توريد الأغذية والحاصلات الزراعية التركية إلى السعودية والخليج.<br>شركة مسجلة في تركيا منذ ",
      ...
      '<div class="fgrid">' +
        '<div>' +
          '<a class="lockup" href="' + HOME + '">' +
            ...
            '<span class="logo-type"><b>TAYIBAT</b><span>' + t("division") + '</span></span>' +
          '</a>' +
          '<p>' + t("fBlurb") +
          '<span class="fill" data-env="FOUNDED_YEAR"' + (EN ? "" : " data-ar-digits") + '>' +
          (EN ? "[year]" : "[سنة التأسيس]") + '</span>.</p></div>' +
